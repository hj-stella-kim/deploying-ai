...
def perform_web_search(query: str) -> str:
    """Google search with Serp API"""
    print("perform google web search...")
...
def perform_event_search(query: str) -> str:
    """Google event search with Serp API"""
    print("perform google event search...")
    google_search = SerpAPIWrapper(
...
def event_search(query: str):
    return perform_event_search(query)
...
if __name__ == "__main__":
    ...
    Provide a clear and well-organized answer based on the above results."""
        ...
        event_result = event_search(search_query)
    ...
    Provide a clear and well-organized answer based on the above information."""
        ...
        print(f"Unknown classification result: {category}")